...
import { ParetoBand, ScalingBand, ExplorerBand } from "./BandLoaders";
...
const BANDS = [
  ...
  { id: "cells", no: "03", kicker: "cell explorer", title: "Every cell, down to the raw reps", Comp: ExplorerBand },
];
